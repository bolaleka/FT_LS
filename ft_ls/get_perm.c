...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/05 14:50:56 by bolaleka          #+#    #+#             */
/*   Updated: 2019/09/17 15:16:36 by bolaleka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		put_time(t_elem *file)
{
	time_t	today;
	char	*s;
...
int				get_file_perm(t_elem *file, int size[7], int flags)
{
	...
	get_mod(str, file->st_mode, file->full_path);
